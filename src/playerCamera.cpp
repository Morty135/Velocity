...
Camera2D playerCamera::update()
{
    if(IsKeyDown(KEY_A))
    {
        currentCameraPos = {Lerp(currentCameraPos.x,playerPos->x - 300, 0.06f), Lerp(currentCameraPos.y,playerPos->y -50, 0.5f)};
    ...
    {
        currentCameraPos = {Lerp(currentCameraPos.x,playerPos->x, 0.06f), Lerp(currentCameraPos.y,playerPos->y -50, 0.5f)};
